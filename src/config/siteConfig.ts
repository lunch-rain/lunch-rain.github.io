...
export const siteConfig: SiteConfig = {
	// 站点标题
	title: managerSettings.title,

	// 站点副标题
	subtitle: managerSettings.subtitle,

	// 站点 URL
	site_url: managerSettings.siteUrl,

	// 站点描述
	description: managerSettings.description,
	...
	// 站点开始日期，用于统计运行天数
	siteStartDate: managerSettings.siteStartDate,
