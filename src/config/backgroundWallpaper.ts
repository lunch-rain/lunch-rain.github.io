...
import managerSettings from "../../manager/site-settings.json";
...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: managerSettings.bannerDesktop || [
			"assets/images/DesktopWallpaper/d1.avif",
			"assets/images/DesktopWallpaper/d2.avif",
		...
		mobile: managerSettings.bannerMobile || [
			"assets/images/MobileWallpaper/m1.avif",
			"assets/images/MobileWallpaper/m2.avif",
		...
		playerUrl: "/assets/videos/rainlove-background.mp4",
	},
	// 横幅壁纸和全屏壁纸共享配置
	common: {
		...
		homeText: {
			...
			enable: true,
			// 主页横幅主标题
			title: managerSettings.bannerTitle,
			// 主页横幅主标题字体大小
			titleSize: "4.5rem",
			// 主页横幅副标题
